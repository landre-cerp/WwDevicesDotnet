...
- Isolate common parts of Pap3Device and FCU into a base Winctrl panel class
- Add support for additional Winctrl panels (e.g. PDC 3N / 3M) when available.
